...
- Production inputs have been broken up into 5 sections
	...
	- Bindery Finishing
	- Interior Boards
- These sections can be toggled on or off
	- in terms of migration, i think if there are values, that section is toggled on on page load
	- each section has its own edit button and aside